...
- **`travel-map-page.css` runs ~0.1 KB under its 46 KB budget (Jul 2026).** The generated
  atlas bundle measures 46,975 of 47,104 allowed LF bytes after the zoomed, compact flight-arc teaser preview, so a large travel/atlas CSS
