...
Read [`AGENTS.md`](../AGENTS.md) first. Use [`build.md`](build.md) for build, deployment, images, and repository-size work; [`review-progress.md`](review-progress.md) for the active review backlog; and [`journals/README.md`](../journals/README.md) plus the complete [`journals/_template.html`](../journals/_template.html) for journal authoring.
...
- The site has exactly two scramble effects: the homepage headline and the Threat Hunting outcome on the experience page. Both use `assets/js/scramble-reveal.js`; do not add a third or remove either as incidental cleanup.
...
- Historical review findings and rejected optimization experiments belong in `docs/review-progress.md`, not here.
