...
- Japan's banner stays full-bleed and uses a lower crop so the original embedded wordmark does not dominate. A smaller warm-ivory `JAPAN` overlay and vermilion rule provide the intentional travel-editorial title treatment.
