...
- **`travel-map-page.css` runs ~1.9 KB under its 48 KB budget (Jul 2026).** The generated
  atlas bundle measures 47,169 of 49,152 allowed LF bytes after the ellipse-matched flight tracer, so a large travel/atlas CSS
