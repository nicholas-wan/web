...
- **`travel-map-page.css` runs ~0.2 KB under its 46 KB budget (Jul 2026).** The generated
  atlas bundle measures 46,935 of 47,104 allowed LF bytes after the curved flight-arc teaser preview, so a large travel/atlas CSS
