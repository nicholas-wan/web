...
- **`travel-map-page.css` runs ~1.3 KB under its 48 KB budget (Jul 2026).** The generated
  atlas bundle measures 47,821 of 49,152 allowed LF bytes after centring the close-cropped flight tracer, so a large travel/atlas CSS
