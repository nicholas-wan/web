...
- **`travel-map-page.css` runs ~1.5 KB under its 46 KB budget (Jul 2026).** The generated
  atlas bundle measures 45,592 of 47,104 allowed LF bytes after the projected mobile teaser preview, so a large travel/atlas CSS
