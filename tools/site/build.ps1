...
foreach ($page in $pages) {
    ...
    $travelMapScript = if ($slug -eq 'travel') { '<script src="assets/js/travel-map.js?v=16"></script>' } else { "" }
    ...
    $routeStylesheets = @()
    if ($slug -eq 'travel') { $routeStylesheets += '    <link rel="stylesheet" href="assets/css/travel-map-page.css?v=3" />' }
...
$preloadMarkup
    ...
    <link rel="stylesheet" href="assets/css/custom.css?v=190" />
