...
foreach ($page in $pages) {
    ...
    $personalTimelineScript = if ($slug -eq 'personal') { '<script src="assets/js/personal-timeline.js?v=18"></script>' } else { "" }
...
$fontAwesomeStylesheet
    <link rel="stylesheet" href="assets/css/custom.css?v=157" />
