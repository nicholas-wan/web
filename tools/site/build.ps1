...
foreach ($page in $pages) {
    ...
    $personalTimelineScript = if ($slug -eq 'personal') { '<script src="assets/js/personal-timeline.js?v=11"></script>' } else { "" }
...
$fontAwesomeStylesheet
    <link rel="stylesheet" href="assets/css/custom.css?v=131" />
