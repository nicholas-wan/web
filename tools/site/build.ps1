...
foreach ($page in $pages) {
    ...
    $scrambleRevealScript = if ($slug -in @('index', 'experience')) { '<script src="assets/js/scramble-reveal.js?v=9"></script>' } else { "" }
...
$fontAwesomeStylesheet
    <link rel="stylesheet" href="assets/css/custom.css?v=128" />
