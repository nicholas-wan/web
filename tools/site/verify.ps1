...
foreach ($page in $pages) {
    ...
    if ($scan -notmatch 'assets/css/main\.css\?v=2' -or $scan -notmatch 'assets/css/custom\.css\?v=129') { throw "$($page.Name) is missing the current shared stylesheet versions." }
...
if ($personal -match 'section-intro--personal|Projects, communities, and memories from 2016|Scroll through the years|personal-timeline__guide' -or $personal -notmatch '<body class="is-preload page-personal">' -or $personal -notmatch '<h1 id="personal-timeline-title">Life outside work</h1>' -or $personal -notmatch 'Personal projects, community work, and milestones over the years\.') { throw "Personal page must begin with concise timeline copy and no redundant scrolling instruction." }
