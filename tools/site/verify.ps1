...
foreach ($page in $pages) {
    ...
    if ($scan -notmatch 'assets/css/main\.css\?v=2' -or $scan -notmatch 'assets/css/custom\.css\?v=140' -or $scan -notmatch 'assets/js/util\.js\?v=1' -or $scan -notmatch 'assets/js/main\.js\?v=18') { throw "$($page.Name) is missing the current shared asset versions." }
