...
foreach ($page in $pages) {
    ...
    if ($scan -notmatch 'assets/css/main\.css\?v=2' -or $scan -notmatch 'assets/css/custom\.css\?v=133') { throw "$($page.Name) is missing the current shared stylesheet versions." }
...
if ($personal -notmatch '<img src="images/personal/cats-banner\.webp" style="--focus-y: 5%"') { throw "The cats banner must keep the focal point that holds Latte's head in the mobile crop." }
$primaryPagers = @{
